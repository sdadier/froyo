...
//        {1400*MHZ,         166*MHZ, (166*MHZ)/2, 166*MHZ, (166*MHZ)/2, 0, 0, 1, 0, 1}, //0x828c0301
        {1300*MHZ,         185*MHZ, (185*MHZ)/2, 185*MHZ, 6, 0, 0, 1, 0, 1}, //0x828c0301
        {1120*MHZ,         185*MHZ, (185*MHZ)/2, 185*MHZ, 5, 0, 0, 1, 0, 1}, // 0xc1f50301

/*        {1200*MHZ,         200*MHZ, (166*MHZ)/2, 166*MHZ, 5, 0, 0, 1, 0, 1}, //0x828c0301
        {1000*MHZ,         200*MHZ, (166*MHZ)/2, 166*MHZ, 4, 0, 0, 1, 0, 1}, // 0xc1f50301
        {800*MHZ,         200*MHZ, (166*MHZ)/2, 166*MHZ, 3, 0, 0, 1, 0, 1},
*/
        {930*MHZ,         185*MHZ, (185*MHZ)/2, 185*MHZ, 4, 0, 0, 1, 0, 1},
        {740*MHZ,         185*MHZ, (185*MHZ)/2, 185*MHZ, 3, 0, 0, 1, 0, 1},
        {(740*MHZ)/2, 185*MHZ, (185*MHZ)/2, 185*MHZ, 3, 1, 0, 1, 0, 1},
        {(740*MHZ)/3, 185*MHZ, (185*MHZ)/2, 185*MHZ, 3, 2, 0, 1, 0, 1},
        {(740*MHZ)/4, 185*MHZ, (185*MHZ)/2, 185*MHZ, 3, 3, 0, 1, 0, 1},
	{(740*MHZ)/5, (185*MHZ)/2, (185*MHZ)/2, 185*MHZ/2, 3, 4, 1, 0, 1, 0},
};
...
//{((1 << 31) | (640 << 16) | (3 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (650 << 16) | (3 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (560 << 16) | (3 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (465 << 16) | (3 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (740 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (740 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (740 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (740 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
{((1 << 31) | (740 << 16) | (6 << 8) | 1), ((1 << 31) | (333 << 16) | (3 << 8) | 3)},
